...
let baseURL = "https://diabrilliance.com/imagedata/natural";
const urlParams = new URLSearchParams(window.location.search);
const id = urlParams.get("id");
const type = urlParams.get("type");
// console.log(type);
if (type == "W") {
    baseURL = "https://diabrilliance.com/imagedata/natural"; // Web URL
} else if (type == "L") {
    baseURL = "D:\\360vidpic\\imagedata"; // Local path (corrected with double backslashes)
}
let totalImages = 256;
